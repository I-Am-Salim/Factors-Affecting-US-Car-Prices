...
Histograms and count plots for variable distributions.

Box plots for price comparisons across categories (e.g. fuel type, make).

Heatmaps for correlation between numerical features.

Feature Insights:

Assesses influence of mileage, engine size, brand, fuel type, and more on price.
